...
elseif ismac
    ...
    %CPC need to adjust these flags for changes to Xcode file location in 10.7 and beyond...
	% options.COMPILER = 'gcc-4.0'; %OLD SUGGESTED LIGHTSPEED COMPILER
    %options.COMPILER = 'llvm-gcc-4.2';
    options.COMPILER = 'llvm-gcc';
	...
	% options.COMPFLAGS =' -fno-common -no-cpp-precomp -arch x86_64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.7.sdk/ -mmacosx-version-min=10.7 -fexceptions'
    options.COMPFLAGS =' -fno-common -no-cpp-precomp -arch x86_64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.10.sdk/ -mmacosx-version-min=10.10 -fexceptions'
